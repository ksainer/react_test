	...
	return (
		<header className="header">
			<div className="wrapper">
				...
				<div className="login">
					{props.isAuth ? <>
						<NavLink to='/profile' className="login__name">{props.login}</NavLink>
						<NavLink to='/logout' className='login__logout'>
					...
					</> : <NavLink to='/login' className='login__name'>Login</NavLink>}
				</div>
			</div>
		</header>
	)
